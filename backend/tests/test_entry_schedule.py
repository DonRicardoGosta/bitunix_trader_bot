"""entry_schedule: live :15/:20 belépési ablak."""
...
def test_live_entry_minutes_are_15_and_20() -> None:
    assert LIVE_ENTRY_MINUTES == (15, 20)


def test_is_live_entry_window_now_15_and_20() -> None:
